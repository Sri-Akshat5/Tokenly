...
import { Shield, Home, Settings as SettingsIcon, LogOut, LayoutDashboard, ChevronRight } from 'lucide-react';
...
export default function DashboardLayout({ children }) {
    ...
    return (
        <div className="min-h-screen bg-black text-white selection:bg-white selection:text-black">
            {/* Top Navigation */}
            <nav className="fixed top-0 inset-x-0 h-20 bg-black/80 backdrop-blur-xl border-b border-zinc-800/50 z-50 px-8">
                <div className="h-full max-w-[1600px] mx-auto flex items-center justify-between">
                    ...
                    <Link to="/dashboard" className="flex items-center gap-3 hover:opacity-80 transition-opacity">
                        ...
                        <span className="text-2xl font-black tracking-tighter">TOKENLY</span>
                    </Link>
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-zinc-800 to-zinc-700 border border-zinc-700 flex items-center justify-center text-zinc-400 font-bold">
                        ...
                        <button
                            ...
                            className="group p-2.5 bg-zinc-900 border border-zinc-800 rounded-xl text-zinc-500 hover:text-white hover:border-zinc-600 transition-all shadow-xl active:scale-95"
            ...
            <div className="flex pt-20">
                ...
                {/* Main Content Area */}
                <main className="flex-1 lg:pl-72 min-h-[calc(100vh-80px)]">
